...
public class main {
    public static void main(String[] args) {
        ...
        packageInfo.setPackagePath("F:\\license-jar\\test");
        packageInfo.setPackgeName("sim-manager-0.1.0-SNAPSHOT-exec.jar");
        packageInfo.setPackgeVersion("2.0");
        packageInfo.setTargetPath("F:\\license-jar\\test\\codejar\\sim-managr-0.1.0-SNAPSHOT-exec");//解压目录+jar名(sim-manager-0.1.0-SNAPSHOT-exec)
